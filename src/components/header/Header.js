                                                        ...
                                                        <div className="col-lg-3">
                                                            <div className="site_author bg-primary">
                                                                ...
                                                                <p className="mb-0 text-white">
                                                                    As a CEO at Meta Software  I have been voice crying in the wilderness,  trying to make requirements clear, use every minute to deliver the  result, and not reinvent the wheel. Here at Meta Software, I made that possible  for the clients.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
